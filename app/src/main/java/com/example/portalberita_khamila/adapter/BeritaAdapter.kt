package com.example.portalberita_khamila.adapter
...
import com.example.portalberita_khamila.data.Berita
...
class BeritaAdapter(private val list: ArrayList<Berita>)
    : RecyclerView.Adapter<BeritaAdapter.BeritaViewHolder>() {
        ...
        class BeritaViewHolder(itemView: View): RecyclerView.ViewHolder(itemView) {
            ...
            private val imgGambar = itemView.findViewById<ImageView>(R.id.txtJudulBerita)
            private val txtDesc = itemView.findViewById<TextView>(R.id.txtJudulBerita)
