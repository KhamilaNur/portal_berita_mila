package com.example.portalberita_khamila
...
import com.example.portalberita_khamila.activity.HomeFragment
...
class MainActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        toqqle = ActionBarDrawerToggle(
            this@MainActivity, drawer,
            0, 0,
        )

        drawer.addDrawerListener(toqqle)
        toqqle.syncState()
